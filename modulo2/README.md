...
1. **Compreender diferentes processos de requisitos:** Analisar como modelos preditivos e ágeis tratam o ciclo de vida dos requisitos.  
2. **Comparar técnicas de especificação:** Entender as diferenças entre casos de uso e user stories.  
3. **Reconhecer a importância da evolução contínua dos requisitos:** Explorar como manter os requisitos alinhados às necessidades em ambientes de mudança constante.  
